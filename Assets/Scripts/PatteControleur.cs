...
public enum EtatPatte { Fixe = 0, Positif = 1, Negatif = -1 };

public class PatteControleur : MonoBehaviour
{

    public EtatPatte rotationEtat = EtatPatte.Fixe;
    ...
    void FixedUpdate()
    {
        if (rotationEtat != EtatPatte.Fixe)
        {
